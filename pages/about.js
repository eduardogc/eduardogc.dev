    ...
    >
      <div className="p-4 md:p-12 text-center lg:text-left">
        ...
        <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
          ...
          <a className="link" href="https://instagram.com/geceduardo" data-tippy-content="@instagram_handle">
            <svg
              className="h-6 fill-current text-gray-600 hover:text-blue-700"
              role="img"
              viewBox="0 0 24 24"
          ...
          <a className="link" href="https://www.tiktok.com/@geceduardo" data-tippy-content="@tiktok_handle">
            <svg
              className="h-6 fill-current text-gray-600 hover:text-blue-700"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
