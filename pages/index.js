  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:image" content="https://cdn.filestackcontent.com/fESs2LcXQHCVMDfx9p4I" />
        <meta property="og:title" content="Eduardo GC" />
      </Head>

      <main className="theme-12 12-theme">
        <div className="container smartpage-container">
          <header><img src="https://cdn.filestackcontent.com/fESs2LcXQHCVMDfx9p4I" className="avatar" alt=""
            title="Eduardo GC" />
            ...
            <ul className="rich-links">
              <li id="block0" className="links-block"><a href="https://amzn.to/2T28tYy"
                title="[POR TEMPO LIMITADO] Toda a loja com desconto em produtos selecionados!"
                ...
                </svg><span>[POR TEMPO LIMITADO] Toda a loja com desconto em produtos selecionados!</span></div>
              </a></li>
              ...
              <li id="block4" className="links-block"><a href="https://youtu.be/jTQSRIjUgyE" target="_blank"
                ...
                className="block-item layout-card play-button" style={{backgroundImage: ''}}>
                ...
                <li id="block6" className="links-block"><a href="https://youtu.be/J7De4B9eTx0" target="_blank"
                  ...
                  className="block-item layout-button-thumbnail play-button" style={{backgroundImage: ''}}>
                ...
                <li id="block8" className="links-block"><a href="https://www.youtube.com/watch?v=HlxzO3m4wlw&list=PLIwitEaTf1XhWhjCqz3S_DQMN7xuMeL03" title="PLAYLIST" target="_blank"
                  ...
                  style={{backgroundImage: `url('https://img.youtube.com/vi/HlxzO3m4wlw/maxresdefault.jpg')`}}>
                  <div className="block-content">
                ...
                <li id="block9" className="links-block"><a href="https://youtube.com/playlist?list=PLIwitEaTf1XgF8zxFuDrCViDWEkexbsbe" title="PLAYLIST" target="_blank"
                  ...
                  <div className="block-content">
                    <div>PLAYLIST</div><strong className="block-label" style={{ backgroundColor: '#F2C94C' }}>PRODUTOS
                            DIGITAIS</strong>
                  </div>
                </a></li>
        </ul>
              <ul className="social-links blocks-num-3">
                <li className="social-item"><a href="https://www.instagram.com/eduardogc.dev/" title="/hciB" target="_blank"><svg
                  aria-labelledby="svg-inline--fa-title-kjRQDSWdnHFf" data-prefix="fab" data-icon="instagram"
                  className="svg-inline--fa fa-instagram fa-w-14 fa-network" role="img"
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                  <title id="svg-inline--fa-title-kjRQDSWdnHFf">instagram</title>
                  <path fill="currentColor"
                ...
                <li className="social-item"><a href="https://twitter.com/eduardogcdev" title="Twitter" target="_blank"><svg
                  aria-labelledby="svg-inline--fa-title-W6ZxvCtp8ruv" data-prefix="fab" data-icon="twitter"
                  className="svg-inline--fa fa-twitter fa-w-16 fa-network" role="img"
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  <title id="svg-inline--fa-title-W6ZxvCtp8ruv">twitter</title>
                  <path fill="currentColor"
                ...
                <li className="social-item"><a href="https://www.youtube.com/channel/UC2-FsOpGAR4_Cumpyo30bTQ/" title="Youtube" target="_blank"><svg
                  aria-labelledby="svg-inline--fa-title-Kzml3iEmeX98" data-prefix="fab" data-icon="youtube"
                  className="svg-inline--fa fa-youtube fa-w-18 fa-network" role="img"
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                  <title id="svg-inline--fa-title-Kzml3iEmeX98">youtube</title>
                  <path fill="currentColor"
                    d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z">
                  </path>
                </svg></a></li>
                <li className="social-item"><a href="https://www.twitch.tv/geceduardo" title="Twitch" target="_blank">
                  <svg
                    aria-labelledby="svg-inline--fa-title-Kzml3iEmeX98" data-prefix="fab" data-icon="youtube"
                    className="svg-inline--fa fa-youtube fa-w-18 fa-network" role="img"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    <title id="svg-inline--fa-title-Kzml3iEmeX98">twitch</title><path fill="currentColor" d="M391.17,103.47H352.54v109.7h38.63ZM285,103H246.37V212.75H285ZM120.83,0,24.31,91.42V420.58H140.14V512l96.53-91.42h77.25L487.69,256V0ZM449.07,237.75l-77.22,73.12H294.61l-67.6,64v-64H140.14V36.58H449.07Z" /></svg>
                </a></li>
              </ul>
