      ...
      <div className=" px-10 py-6 mx-auto">
        ...
        <div className="max-w-6xl px-10 py-6 mx-auto bg-gray-50">
          ...
          <div className="mt-2">
            ...
            <div className="font-light text-gray-600">
              ...
              <a href="#" className="flex items-center mt-6 mb-6"><img
                ...
                <h1 className="font-bold text-gray-700 hover:underline">By James Amos, <ReactMarkdown>{formatDate(frontmatter.date)}</ReactMarkdown></h1>
              </a>
            </div>
          </div>
          ...
          <div className="max-w-4xl px-10  mx-auto text-2xl text-gray-700 mt-4 rounded bg-gray-100">
            <div>
              <p className="mt-2 p-8"><ReactMarkdown>{content}</ReactMarkdown></p>
            </div>
          </div>
        </div>
